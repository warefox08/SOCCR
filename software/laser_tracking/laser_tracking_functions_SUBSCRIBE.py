...
def search_for_laser(fov_h, res_h):
    ...
    depth_frame = rospy.Subscriber("/camera1/aligned_depth_to_color/image_raw", Image, image_callback)
    color_image = rospy.Subscriber("/camera1/color/image_raw", Image, image_callback)
